...
export interface FeaturesBlock {
  ...
  features?:
    | {
        icon?: ('camera' | 'cloud' | 'shield' | 'mobile' | 'moon' | 'bell' | 'audio' | 'ai' | 'zap' | 'wifi') | null;
        title: string;
        description: string;
        id?: string | null;
      }[]
...
export interface ProductsShowcaseBlock {
  ...
  heading: string;
  subheading?: string | null;
  displayMode?: ('grid' | 'featured') | null;
...
export interface Product {
  ...
  description?: string | null;
  image?: (number | null) | Media;
  category: 'indoor' | 'outdoor' | 'ptz' | 'doorbell' | 'floodlight';
...
export interface Header {
  id: number;
  /**
   * Nhập số pixel (ví dụ: 80)
   */
  height?: number | null;
  /**
   * Chọn cách căn chỉnh nội dung
   */
  justify?: ('start' | 'center' | 'end' | 'between') | null;
  /**
   * Chọn cách căn chỉnh nội dung theo trục dọc
   */
  alignItems?: ('start' | 'center' | 'end') | null;
  navItems?:
    | {
        justify?: ('start' | 'center' | 'end') | null;
        itemType?: ('single' | 'dropdown' | 'icon') | null;
        icon?: ('user' | 'search' | 'shopping-cart' | 'bell') | null;
        link?: {
          type?: ('reference' | 'custom') | null;
          newTab?: boolean | null;
          reference?:
...
export interface Footer {
  id: number;
  /**
   * Site name shown next to the logo.
   */
  ...
  socialLinks?:
    | {
        platform: 'facebook' | 'twitter' | 'youtube' | 'linkedin' | 'instagram' | 'tiktok' | 'github';
        url: string;
        id?: string | null;
      }[]
    | null;
...
export interface Layout {
  ...
  lightColors?: {
    /**
     * CSS color value. Bỏ trống = dùng giá trị mặc định trong globals.css.
     */
  ...
  typography?: {
    ...
    headingFont?:
      ...
      | null;
    monoFont?:
      | ('geist-mono' | 'Fira Code' | 'JetBrains Mono' | 'Source Code Pro' | 'Inconsolata' | 'IBM Plex Mono')
      | null;
    baseFontSize?: ('14px' | '16px' | '18px') | null;
    headingFontWeight?: ('400' | '500' | '600' | '700' | '800' | '900') | null;
    lineHeight?: ('1.4' | '1.5' | '1.6' | '1.75') | null;
  };
  spacing?: {
    /**
     * Tất cả component (button, card, input…) thừa kế từ biến này.
     */
    radius?: ('0' | '0.25rem' | '0.5rem' | '0.625rem' | '0.75rem' | '1rem' | '9999px') | null;
    containerWidth?: ('sm' | 'md' | 'lg' | 'xl' | '2xl' | 'full') | null;
  };
  updatedAt?: string | null;
  createdAt?: string | null;
}
