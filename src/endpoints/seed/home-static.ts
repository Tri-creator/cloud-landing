  ...
  layout: [
    ...
    // Pricing
    {
      ...
      plans: [
        {
          name: 'Người mới',
          description: 'Hoàn hảo để sử dụng tại nhà',
          price: 0,
          annualPrice: 0,
          highlighted: false,
          ctaLabel: 'Bắt đầu dùng miễn phí',
          ctaHref: '#signup',
          features: [
            { text: '2 camera', included: true },
            { text: 'Lưu trữ đám mây 7 ngày', included: true },
            { text: 'Ghi hình 1080p', included: true },
            { text: 'Truy cập ứng dụng di động', included: true },
            { text: 'Phát hiện thông minh AI', included: false },
            { text: 'Lưu trữ không giới hạn', included: false },
          ],
        },
        {
          name: 'Chuyên nghiệp',
          description: 'Để đảm bảo an ninh nghiêm túc cho ngôi nhà',
          price: 9,
          annualPrice: 7,
          highlighted: true,
          ...
          ctaHref: '#signup',
          features: [
            { text: 'Tối đa 10 camera', included: true },
            { text: 'Lưu trữ đám mây 30 ngày', included: true },
            { text: 'Ghi hình 4K Ultra HD', included: true },
            { text: 'Phát hiện thông minh AI', included: true },
            { text: 'Âm thanh hai chiều', included: true },
        ...
        },
        {
          ...
          ctaHref: '#contact',
          features: [
            { text: 'Camera không giới hạn', included: true },
            { text: 'Lưu trữ đám mây 90 ngày', included: true },
            { text: 'Ghi hình 4K Ultra HD', included: true },
            { text: 'Phát hiện thông minh AI', included: true },
            { text: 'Quy tắc cảnh báo tùy chỉnh', included: true },
            { text: 'Người quản lý tài khoản chuyên dụng', included: true },
          ],
        },
      ],
    },
